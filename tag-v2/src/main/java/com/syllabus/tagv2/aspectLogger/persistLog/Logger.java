package com.syllabus.tagv2.aspectLogger.persistLog;
...
public class Logger {
    ...
    private void initializeLogFile() {
        createLogFileName();
        try {
            fileWriter = new PrintWriter(new FileWriter("src/main/java/com/syllabus/tagv2/aspectLogger/persistLog/logs/"+logFileName, true));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    private void removeOldLogFiles() {
        ...
        File logsDirectory = new File("src/main/java/com/syllabus/tagv2/aspectLogger/persistLog/logs/");
